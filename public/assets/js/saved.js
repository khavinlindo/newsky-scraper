...
$(document).ready(function() {
    ...
    function initPage() {
     ...
     function renderEmpty() {
        ...
        $(["<div class='alert alert-warning text-center'>",
           ...
           "<h4><a href='/'>Browse Articles Articles</a></h4>",
           "</div>",
           "</div>"
        ].join(""));
    ...
    function renderNotesList(data) {
        ...
        // Also settling up a currentNote variable to temporarily store each note
       ...
       // Appending notesToRender to the note-container inside the note modal
       $(".note-container").append(notesToRender);
    }


    function handleNoteSave() {
        // This function handles what happns when a user tries to save a new note for an article
